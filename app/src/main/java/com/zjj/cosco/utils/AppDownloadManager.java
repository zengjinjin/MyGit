...
public class AppDownloadManager {
    ...
    public void downloadApk(String apkUrl, String title, String desc) {
        ...
        fileName  = URLUtil.guessFileName(apkUrl, desc, "");
        ...
        request.setDestinationInExternalFilesDir(weakReference.get(), Environment.DIRECTORY_DOWNLOADS, fileName);
